...
const translations = {
  es: {
    ...
    card_un_title: "Panel de Expertos ONU (Informe interino)",
    card_un_text: "\"En síntesis, el proceso de gestión de resultados del CNE no cumplió con las medidas básicas de transparencia e integridad necesarias para elecciones creíbles.\" (Traducción propia)",
  ...
  en: {
    ...
    card_un_title: "UN Panel of Experts (Interim report)",
