...
const translations = {
  es: {
    ...
    faq_q1_a: "Para que un resultado sea verificable públicamente, la ley exige dos pasos que deben cumplirse con evidencia documental:",
    ...
    faq_q3_note: "Reportes independientes indican que fueron suspendidas; sin ellas no hay verificación técnica independiente.",
    ...
    faq_q4_a: "No. Incluso en procesos cuestionados anteriores, el CNE publicó resultados desagregados en su web.",
    ...
    faq_q5_a: "No se trata de creer a actores políticos; se trata de verificar evidencia independiente:",
    faq_q5_item1: "Actas verificables con QR, número de serie y sello oficial.",
    faq_q5_item2: "La validez del acta es técnica y no depende de firmas.",
    faq_q5_item3: "Análisis estadísticos independientes (UCLA, Columbia, Berkeley, U. Michigan).",
    faq_q5_item4: "Observación internacional con metodología propia (Centro Carter, ONU, UE).",
    ...
    faq_q6_a: "La explicación del \"hackeo\" no sustituye la verificación técnica:",
    faq_q6_item1: "Según la documentación del CNE, el sistema no está conectado a internet durante la votación.",
    faq_q6_item2: "Las actas físicas impresas permiten contrastar lo transmitido.",
    faq_q6_item3: "Ante un incidente, la respuesta técnica es ejecutar auditorías, no suspenderlas.",
    ...
    faq_q10: "¿Las actas sin firma son inválidas?",
    faq_q10_a: "No. La validez de un acta depende de elementos técnicos verificables:",
    ...
    faq_q10_note: "La firma es un respaldo, pero su ausencia no invalida el acta; evita que una negativa bloquee la verificación.",
    ...
    faq_q7_a: "El Centro Carter es un observador electoral sin afiliación partidista; ha observado 113 elecciones en 39 países.",
    ...
    faq_q8_a: "Son controles técnicos posteriores a la elección que permiten verificar la integridad del proceso. La triada post-electoral incluye:",
    ...
    faq_q9_item2: "Las auditorías generan evidencia técnica (actas, registros, muestras) que no surge de una decisión judicial.",
  ...
  en: {
    ...
    faq_q1: "Are the results final?",
    faq_q1_a: "For results to be publicly verifiable, the law requires two steps supported by documentary evidence:",
    faq_q1_item1: "Publication of precinct-level results within 48 hours (Art. 146 LOPRE).",
    faq_q1_item2: "Carry out the post-election audits defined in CNE protocols.",
    faq_q1_note: "Without those steps there is no independent verification, only proclamation.",
    faq_q1_link1: "CNE: totalization",
    faq_q1_link2: "CNE: audits",
    faq_q2: "Is publication in the Gazette not a priority?",
    faq_q2_a: "LOPRE sets two distinct and mandatory deadlines:",
    ...
    faq_q2_note: "They are separate obligations; one does not replace the other.",
    faq_q2_link1: "Art. 155 LOPRE",
    faq_q2_link2: "CNE: electoral schedule",
    faq_q3: "Were post-election audits conducted?",
    faq_q3_a: "CNE protocols establish three mandatory post-election audits, with technical records and reports:",
    ...
    faq_q3_note: "Independent reports indicate they were suspended; without them there is no independent technical verification.",
    ...
    faq_q4_a: "No. Even in earlier contested processes, the CNE published precinct-level results on its website.",
    ...
    faq_q5_a: "This is not about believing political actors; it is about verifying independent evidence:",
    faq_q5_item1: "Actas verifiable by QR code, serial number, and official seal.",
    faq_q5_item2: "Acta validity is technical and does not depend on signatures.",
    faq_q5_item3: "Independent statistical analyses (UCLA, Columbia, Berkeley, U. Michigan).",
    faq_q5_item4: "International observation with its own methodology (Carter Center, UN, EU).",
    ...
    faq_q6_a: "The \"hack\" claim does not replace technical verification:",
    ...
    faq_q6_item3: "After an incident, the technical response is to run audits, not suspend them.",
    ...
    faq_q10: "Are unsigned actas invalid?",
    faq_q10_a: "No. An acta's validity depends on verifiable technical elements:",
    ...
    faq_q10_note: "A signature is supportive but not required; its absence should not void a valid acta.",
    faq_q10_link1: "See citizen actas",
    faq_q10_link2: "How to verify an acta",
    faq_q7: "Isn't the Carter Center biased?",
    faq_q7_a: "The Carter Center is a nonpartisan electoral observer; it has observed 113 elections in 39 countries.",
    ...
    faq_q8_a: "They are post-election technical checks that verify the integrity of the process. The post-election triad includes:",
    ...
    faq_q9_item2: "Audits produce technical evidence (actas, logs, samples) that a judicial decision cannot generate.",
