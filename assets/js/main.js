...
const translations = {
  es: {
    ...
    faq_q10_a: "No. La validez de un acta se basa en elementos técnicos verificables, no en las firmas:",
    ...
    faq_q10_item4: "Coherencia con otras actas de la misma mesa/centro.",
    faq_q10_note: "Esto evita que la negativa de firmar pueda anular un acta válida y protege la evidencia física del proceso.",
    ...
    faq_q9_a: "No. Las obligaciones del CNE están definidas por ley y por sus propios protocolos técnicos, y deben cumplirse con evidencia verificable:",
    faq_q9_item1: "El CNE debe publicar resultados desagregados y cumplir plazos legales (Art. 146 y 155 LOPRE).",
    faq_q9_item2: "Las auditorías post-electorales son procedimientos técnicos que requieren actas físicas, registros y muestras aleatorias.",
    faq_q9_item3: "Una sentencia judicial no genera esos datos ni reemplaza la verificación técnica independiente.",
  ...
  en: {
    ...
    faq_q10_a: "No. An acta's validity rests on verifiable technical elements, not on signatures:",
    ...
    faq_q10_item4: "Consistency with other actas from the same precinct/center.",
    faq_q10_note: "This prevents a refusal to sign from voiding a valid acta and protects the physical evidence.",
    ...
    faq_q9_a: "No. The CNE's duties are defined by law and by its own technical protocols and must be met with verifiable evidence:",
    faq_q9_item1: "The CNE must publish precinct-level results and comply with legal deadlines (Art. 146 and 155 LOPRE).",
    faq_q9_item2: "Post-election audits are technical procedures that require physical actas, logs, and random samples.",
    faq_q9_item3: "A court ruling does not generate that data or replace independent technical verification.",
