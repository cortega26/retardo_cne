...
const translations = {
  es: {
    ...
    editorial_title: "Calendario editorial (6 semanas)",
    editorial_subtitle: "Una pieza semanal con enfoque verificable y fuentes primarias.",
    editorial_week1_label: "Semana 1",
    editorial_week1_text: "Plazos legales y obligaciones del CNE.",
    editorial_week2_label: "Semana 2",
    editorial_week2_text: "Auditorías post-electorales no realizadas.",
    editorial_week3_label: "Semana 3",
    editorial_week3_text: "Actas verificables: QR, número de serie y sello.",
    editorial_week4_label: "Semana 4",
    editorial_week4_text: "Comunicados oficiales vs evidencia disponible.",
    editorial_week5_label: "Semana 5",
    editorial_week5_text: "Comparación histórica 2018-2024.",
    editorial_week6_label: "Semana 6",
    editorial_week6_text: "Observación internacional y estándares técnicos.",
  ...
  en: {
    ...
    editorial_title: "Editorial calendar (6 weeks)",
    editorial_subtitle: "One weekly piece with verifiable framing and primary sources.",
    editorial_week1_label: "Week 1",
    editorial_week1_text: "Legal deadlines and CNE obligations.",
    editorial_week2_label: "Week 2",
    editorial_week2_text: "Post-election audits not carried out.",
    editorial_week3_label: "Week 3",
    editorial_week3_text: "Verifiable actas: QR, serial number, seal.",
    editorial_week4_label: "Week 4",
    editorial_week4_text: "Official statements vs available evidence.",
    editorial_week5_label: "Week 5",
    editorial_week5_text: "Historical comparison 2018-2024.",
    editorial_week6_label: "Week 6",
    editorial_week6_text: "International observation and technical standards.",
