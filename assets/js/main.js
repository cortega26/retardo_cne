...
const translations = {
  es: {
    ...
    system_actual_step1: "Cumplido: La votación en máquinas se realizó.",
    system_actual_step2: "Cumplido: Se imprimieron comprobantes físicos.",
    system_actual_step3: "Cumplido: Se emitieron actas físicas con QR, número de serie y sello.",
    system_actual_step4: "Incumplido: Las actas físicas no se auditaron en fases post-electorales.",
    system_actual_step5: "Incumplido: La transmisión se detuvo el 28/07 a las 10 PM.",
    system_actual_step6: "Incumplido: No se publicaron resultados desagregados en 48 horas (Art. 146 LOPRE).",
    system_actual_step7: "Incumplido: Las tres auditorías post-electorales fueron suspendidas.",
    system_actual_step8:
      "Incumplido: No hubo publicación en Gaceta Electoral dentro del plazo legal (Art. 155 LOPRE).",
  ...
  en: {
    ...
    system_expected_step2: "The machine prints the physical receipt.",
    system_expected_step3: "At closing, the machine prints the acta with results (QR, serial number, official seal).",
    system_expected_step4: "A physical acta remains at the precinct for audits.",
    ...
    system_actual_step1: "Met: Voting on machines took place.",
    system_actual_step2: "Met: Physical receipts were printed.",
    system_actual_step3: "Met: Physical actas with QR, serial number, and seal were issued.",
    system_actual_step4: "Failed: Physical actas were not audited in post-election phases.",
    system_actual_step5: "Failed: Transmission stopped on 07/28 at 10 PM.",
    system_actual_step6: "Failed: No precinct-level results were published within 48 hours (Art. 146 LOPRE).",
    system_actual_step7: "Failed: The three post-election audits were suspended.",
    system_actual_step8: "Failed: No Electoral Gazette publication within the legal deadline (Art. 155 LOPRE).",
